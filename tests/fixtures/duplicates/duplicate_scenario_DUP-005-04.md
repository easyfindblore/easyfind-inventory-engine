# Duplicate Scenario: Formatting Differences

## Scenario ID: DUP-005-04

## Expected Outcome: Existing Property Updated (No new data, if content is same)
...
Rent: 60000
Location: Bellandur
Map: https://maps.app.goo.gl/4nfELrcWceTNMZ61A
```
