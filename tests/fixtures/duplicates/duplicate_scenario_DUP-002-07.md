# Duplicate Scenario: Near Duplicate (Society Name variation)

## Scenario ID: DUP-002-07

## Expected Outcome: New Property (if society is primary key) or Existing Property Updated (if other fields match)
...
Community: Semi Gated
Location: Kasavanahalli
Society/Landmark: Sobha Dream Acres (Phase 2)
Google Maps Link: https://maps.app.goo.gl/4nfELrcWceTNMZ61A
```
